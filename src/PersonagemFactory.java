...
public class PersonagemFactory {
    public static List<Feiticeiro> criarFeiticeiro() {
        ...
        feiticeiros.add(new Feiticeiro("Yuji Itadori", "Feiticeiro de Grau Especial", new Ataque[]{
        ...
        feiticeiros.add(new Feiticeiro("Nanami Kento", "Feiticeiro de 1ª Classe!",new Ataque[]{
        ...
        feiticeiros.add(new Feiticeiro("Yuta Okkotsu", "Feiticeiro de Grau Especial", new Ataque[]{
    ...
    public static List<Vilao> crarViloes() {
        ...
        viloes.add(new Vilao("Hyomen Sukuna", "Rei das maldições", new Ataque[]{
            new Ataque("Kai", 25),
            new Ataque("Enju", 20),
            new Ataque("Hachi", 18),
        ...
        viloes.add(new Vilao("Mahito", "Espirito Amaldiçoado", new Ataque[]{
        ...
        viloes.add(new Vilao("Jogo", "Espirito Amaldiçoado de Fogo", new Ataque[]{
